<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">
                Kelola akun staff keuangan SMP IT As-Sulthon.
            </p>
        </div>
    </x-slot>
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500">
                        Data pengguna dengan role staff keuangan.
                    </p>
                </div>
                            ...
                            <tr class="hover:bg-[#F8F6F0] transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <button type="button" onclick="openModal('modal-{{ $staff->id }}')"
                                        ...
                                        <form action="{{ route('admin.staff.destroy', $staff->id) }}" method="POST"
                                            class="delete-form" data-nama="{{ $staff->name }}">
                                            @csrf
                                            @method('DELETE')
    ...
    @foreach ($staffs as $staff)
        <div id="modal-{{ $staff->id }}" onclick="closeModal('modal-{{ $staff->id }}')"
            ...
            <div onclick="event.stopPropagation()"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-[#F5E7B2]">
                                Informasi akun staff keuangan
                            </p>
                        </div>

                        <button type="button" onclick="closeModal('modal-{{ $staff->id }}')"
                ...
                <div class="p-6 space-y-4">
                    <div class="rounded-2xl bg-[#F8F6F0] border border-[#F5E7B2] p-4">
                        <p class="text-xs text-slate-500">Nama Staff</p>
        ...
        document.querySelectorAll('.delete-form').forEach(form => {
            form.addEventListener('submit', function(e) {
                ...
                Swal.fire({
                    title: 'Hapus Staff?',
                    html: `
                        <p>Data staff <b>${nama}</b> akan dihapus.</p>
